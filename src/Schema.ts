...
export interface KycLink extends Usd {}

export interface KycLinkResponseExample {
  data?: Data
  message?: string
  status?: boolean
}
...
export interface ExtractedApiDocumentApi {
  ...
  kycLinks: {
    create(body: KycLinkInput): Promise<Usd>
  }
          ...
          content: {
            'application/json': {
              schema: {
                ...
                example: {
                  customer_id: '1422c261d1dd4daeab887d2cf347cf2a',
                },
                required: ['customer_id'],
              },
              example: {
                ...
                schema: {
                  ...
                  properties: {
                    ...
                    data: {
                      ...
                      example: {
                        Reference: '12598b0c-5bdc-413e-8e36-61d1945e5037',
                      },
                    },
                  },
                  example: {
